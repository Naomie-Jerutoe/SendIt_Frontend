...
Slide.defaultProps = {
  ...
  testimonial:
    '“Love it! I really like the user interface. The sleek aesthetic of the software makes it easy and pleasant to use. I am also a big fan of the way I can easily track all my parcels.”',
  rootClassName: '',
  imageSrc:
