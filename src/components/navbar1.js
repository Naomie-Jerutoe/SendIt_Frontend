      ...
      <header data-role="Header" className="navigation-container">
        ...
        <div className="navbar1-nav">
          ...
          <div
            ...
            className="navbar1-thq-dropdown list-item"
          >
            <ul data-thq="thq-dropdown-list" className="navbar1-dropdown-list">
              <li
                data-thq="thq-dropdown"
                className="navbar1-dropdown list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="navbar1-dropdown-toggle"
                >
              ...
              <li
                data-thq="thq-dropdown"
                className="navbar1-dropdown1 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="navbar1-dropdown-toggle1"
                >
                  <span className="navbar1-text1">{props.text3}</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div data-role="MobileMenu" className="navigation-mobile-menu">
          ...
          <div className="navbar1-social-media">
            <span className="navbar1-text2">{props.text}</span>
            <div className="navbar1-container1">
              ...
              <svg viewBox="0 0 1024 1024" className="navbar1-icon08">
                <path
